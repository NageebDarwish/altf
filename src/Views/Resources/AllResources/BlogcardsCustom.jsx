...
const BlogcardsCustom = ({ blog }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <h2 className="text-[26px] font-bold font-pally text-[#0C3373]">{blog.title}</h2>
        <p className="text-gray-600 font-HelveticaNeue text-[16px] mt-2">{blog.description}</p>
        <div className="flex justify-between items-center mt-4">
          <button 
            className="mt-4 bg-orange-500 font-HelveticaNeue text-white py-2 px-4 text-[14px] rounded-full hover:bg-orange-600 transition"
          >
            Read More
          </button>
